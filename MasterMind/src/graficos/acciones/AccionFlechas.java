...
public class AccionFlechas extends KeyAdapter {
	...
	/**
	 * Tablero sobre el que recae la acciÃ³n
	 */
	...
	/**
	 * Columna de la casilla que recibe la acción.
	 */
	private int columna;

	/**
	 * Inicia la clase de la acción recogiendo el casillero y la fila y columna
